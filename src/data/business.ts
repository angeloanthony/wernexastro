...
export const WERNEX = {
  ...
  // aggregateRating structured data is rendered ONLY on /testimonials, where the actual
...
export const NAV_LINKS = [
  ...
  { href: "/bug-identifier", label: "Identify a Bug" },
  { href: "/blog", label: "Blog" },
  { href: "/testimonials", label: "Reviews" },
  { href: "/contact", label: "Schedule Appt" },
] as const;
